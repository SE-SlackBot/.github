...
시스템 계약은 [spec.md](../spec.md), 모듈 구조는 [plan.md](../plan.md#구현-방향), 사용자용 요약은 [README.md](https://github.com/SE-SlackBot/main/blob/main/README.md).
...
설치·실행은 [README 시작하기](https://github.com/SE-SlackBot/main/blob/main/README.md#시작하기)를 따릅니다. `.env`는 `load_dotenv()`가 읽습니다.
